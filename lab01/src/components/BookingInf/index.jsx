...
function BookingInf(props) {
    ...
    const [bookingInf, setBookingInf] = useState(null);
                ...
                {submitted && (
                    <div className="result-info">
                        ...
                        <div className="result-customer-info">
                            ...
                            <p>Họ tên: {capitalizeEachWord(BookingInf.customerInfo.name)} - Độ tuổi: {BookingInf.customerInfo.age} / Giới tính: {BookingInf.customerInfo.gender}</p>
                            <p>Địa chỉ: {capitalizeEachWord(BookingInf.customerInfo.address)}</p>
                        </div>
                        <div className="result-booking-info">
                            <p><strong>Thông tin đặt chỗ</strong></p>
                            <p>Số khách tham gia bữa tiệc: {BookingInf.reservationInfo.numberOfGuests} - Ngày đặt tiệc: {formatDateWithoutTime(BookingInf.reservationInfo.date)}</p>
                            <p>Loại tiệc: - {BookingInf.reservationInfo.mealType} / Địa điểm: {BookingInf.reservationInfo.location}</p>
                        </div>
                        <div className="result-other-info">
                            <p><strong>Các yêu cầu kèm theo:</strong></p>
                            <ul>
                                {BookingInf.reservationInfo.otherRequests.map((request, index) => (
                                    <li key={index}>- {request}</li>
                                ))}
                            </ul>
                        </div>
                        <p className="result-contact-info">Quý khách biết đến nhà hàng của chúng tôi qua: {BookingInf.reservationInfo.howYouKnowUs}</p>
                        <p className="result-datetime-info">Chúng tôi đã nhận được thông tin đặt chỗ của quý khách vào lúc: <strong>{formatTimestamp(BookingInf.reservationInfo.timestamp)}</strong></p>
                    </div>
                )}
            </div>
