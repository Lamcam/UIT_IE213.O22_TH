...
function LearningOutcomes(props) {
    ...
    return (
        <div className='container container-learing-outcomes'>
            <div className="learing-outcomes-title">
                <h2>KẾT QUẢ HỌC TẬP</h2>
            </div>
            <form className="learing-outcomes-form" onSubmit={handleSubmit} method="post" action={window.location.pathname}>
